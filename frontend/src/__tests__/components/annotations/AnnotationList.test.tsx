...
describe('AnnotationList - Markdown Rendering', () => {
  ...
  describe('Blockquotes and Mixed Content', () => {
    it('should render blockquotes', async () => {
      ...
      await waitFor(() => {
        const blockquote = screen.getByText(/This is a quote/, { selector: 'blockquote *' });
  ...
  describe('Plain Text Handling', () => {
    it('should render plain text without markdown', async () => {
      ...
      await waitFor(() => {
        const text = screen.getByText('This is just plain text without any markdown');
    ...
    it('should not render description for null text_content', async () => {
      ...
      await waitFor(() => {
        ...
        expect(screen.queryByTestId('annotation-description')).not.toBeInTheDocument();
      });
    });
