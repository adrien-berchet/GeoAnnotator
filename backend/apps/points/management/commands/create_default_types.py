...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        default_types = [
            ...
            {
                "names": {"en": "Viewing Point", "fr": "Point de vue"},
                "icon": "viewpoint.png",
                "order": 1,
            },
            ...
            {
                "names": {"en": "Crossroads", "fr": "Carrefour"},
                "icon": "crossroad.png",
                "order": 33,
            },
            {"names": {"en": "Border", "fr": "Frontière"}, "icon": "border.png", "order": 34},
            {
                "names": {"en": "Landmark", "fr": "Point de repère"},
                "icon": "landmark.png",
                "order": 35,
            },
            # === SAFETY & HAZARDS (36-45) ===
            {
                "names": {"en": "Dangerous Area", "fr": "Zone dangereuse"},
                "icon": "danger.png",
                "order": 36,
            },
            {"names": {"en": "Mine", "fr": "Mine"}, "icon": "mine.png", "order": 37},
            {
                "names": {"en": "Hunting Area", "fr": "Zone de chasse"},
                "icon": "hunting_area.png",
                "order": 38,
            },
            ...
            {
                "names": {"en": "First Aid", "fr": "Premiers secours"},
                "icon": "first-aid.png",
                "order": 44,
            },
            ...
            {
                "names": {"en": "Hot Air Balloon", "fr": "Montgolfière"},
            ...
            {
                "names": {"en": "Archaeological Site", "fr": "Site archéologique"},
                "icon": "🏛️",
                "order": 86,
            },
            ...
            {
                "names": {"en": "Historical Site", "fr": "Site historique"},
                "icon": "📜",
                "order": 95,
            },
            # === SERVICES (96-110) ===
            ...
            {
                "names": {"en": "Accessible", "fr": "Handicapé"},
                "icon": "accessible.png",
                "order": 110,
            },
        ...
        for type_data in default_types:
            ...
            existing_types = PointType.objects.filter(
                owner=None, type_choice="base", names__has_key="en"
            )
            ...
            if point_type is None:
                ...
                if needs_update:
                    ...
                    self.stdout.write(
                        self.style.SUCCESS(f"Default type already up-to-date: {english_name}")
                    )

        # Summary
        self.stdout.write("\n" + "=" * 60)
        if created_count > 0:
            self.stdout.write(self.style.SUCCESS(f"✓ Created {created_count} new default type(s)"))
        if updated_count > 0:
            self.stdout.write(
                self.style.SUCCESS(f"✓ Updated {updated_count} existing default type(s)")
            )
        if created_count == 0 and updated_count == 0:
            self.stdout.write(
                self.style.SUCCESS("✓ All default types already exist and are up-to-date")
            )
