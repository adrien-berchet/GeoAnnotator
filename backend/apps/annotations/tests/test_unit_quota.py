...
class TestStorageQuota:
    ...
    def gps_point(self, user):
        ...
        return GPSPoint.objects.create(title="Test Point", location=Point(0, 0), owner=user)
    ...
    def test_update_quota_after_upload(self, user, gps_point):
        ...
        AnnotationService.create_file_annotation(
            gps_point_id=gps_point.id, annotation_type="image", uploaded_file=file, user=user
        )
    ...
    def test_text_annotation_no_quota_impact(self, user, gps_point):
        ...
        AnnotationService.create_text_annotation(
            gps_point_id=gps_point.id, text_content="<p>This is a text annotation</p>"
        )
