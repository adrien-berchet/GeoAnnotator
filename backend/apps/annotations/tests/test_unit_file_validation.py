...
class TestFileUploadValidation:
    ...
    def test_validate_image_jpeg(self):
        ...
        file = SimpleUploadedFile("test.jpg", b"fake jpeg content", content_type="image/jpeg")
    ...
    def test_validate_image_gif(self):
        ...
        file = SimpleUploadedFile("test.gif", b"fake gif content", content_type="image/gif")
    ...
    def test_validate_image_webp(self):
        ...
        file = SimpleUploadedFile("test.webp", b"fake webp content", content_type="image/webp")
    ...
    def test_validate_document_txt(self):
        ...
        file = SimpleUploadedFile("test.txt", b"fake text content", content_type="text/plain")
    ...
    def test_validate_document_csv(self):
        ...
        file = SimpleUploadedFile("test.csv", b"fake csv content", content_type="text/csv")
    ...
    def test_validate_file_too_large(self):
        ...
        file = SimpleUploadedFile("large.jpg", b"x", content_type="image/jpeg")
    ...
    def test_validate_disallowed_executable(self):
        ...
        file = SimpleUploadedFile(
            "test.unknown_exe", b"fake executable", content_type="application/x-executable"
        )
    ...
    def test_validate_disallowed_script(self):
        ...
        # Use a non-standard extension so mimetypes.guess_type returns None
        file = SimpleUploadedFile(
            "test.unknown_sh", b"#!/bin/bash", content_type="application/x-sh"
        )
    ...
    def test_validate_disallowed_javascript(self):
        ...
        # Use a non-standard extension so mimetypes.guess_type returns None
        file = SimpleUploadedFile(
            "test.unknown_js", b"console.log('test');", content_type="application/javascript"
        )
    ...
    def test_validate_generic_file_type(self):
        ...
        file = SimpleUploadedFile("test.zip", b"fake zip content", content_type="application/zip")
    ...
    def test_validate_mime_type_from_filename(self):
        ...
        file = SimpleUploadedFile("test.jpg", b"fake content")
    ...
    def test_validate_file_size_edge_case_exact_limit(self):
        ...
        file = SimpleUploadedFile("exact.jpg", b"x", content_type="image/jpeg")
    ...
    def test_validate_all_allowed_image_types(self):
        ...
        for mime_type in allowed_types:
            file = SimpleUploadedFile(
                f"test.{mime_type.split('/')[1]}", b"fake content", content_type=mime_type
            )
    ...
    def test_validate_all_allowed_document_types(self):
        ...
        for mime_type in allowed_types:
            ...
            file = SimpleUploadedFile(f"test.{extension}", b"fake content", content_type=mime_type)
